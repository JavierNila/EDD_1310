...
public class Trabajador {
	...
	public Trabajador(int numeroTrabajador, String nombre, String paterno, String materno, int horasExtra,
	...
	public String toString() {
		String data = "#: " + numeroTrabajador + ", Nombre: " + nombre + " " + paterno + " " + materno
				+ ", Horas extra: " + horasExtra + ", Sueldo base: " + sueldoBase + ", Anio de ingreso: " + anioIngreso;
		return data;
	}
}